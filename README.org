...
4. =?<feature>=
   ...
   A feature configuration set defines deactivatable package options and
   ...
   By convention, it groups settings around a specific feature (X, wayland,
   pipewire, etc.), and could be referenced in the machine set file to disable
   it.
